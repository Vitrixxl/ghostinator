...
export function Dossier({
  ...
  return (
    <section className="min-w-0 overflow-hidden">
      ...
      <div className="mt-5 grid min-w-0 gap-5 sm:mt-6 sm:gap-6 lg:grid-cols-[1fr_1.4fr]">
        <article className="leaf relative min-w-0 overflow-hidden p-4 sm:p-6">
          ...
          <h3 className="masthead mt-3 break-all text-2xl sm:mt-4 sm:text-3xl md:text-4xl">
            @{identity.username}
          </h3>
          ...
          <dl className="mt-5 space-y-3">
            <div className="min-w-0">
              ...
              <dd className="break-all font-mono text-[12px] text-graphite">
                {shortHash(identity.publicHash, 12)}
              </dd>
            </div>
            <div className="min-w-0">
              <dt className="kicker">Signature d'auth</dt>
              <dd className="break-words font-mono text-[12px] text-graphite">Ed25519 (WebCrypto)</dd>
            </div>
            <div className="min-w-0">
              <dt className="kicker">DM E2EE</dt>
              <dd className="break-words font-mono text-[12px] text-graphite">
